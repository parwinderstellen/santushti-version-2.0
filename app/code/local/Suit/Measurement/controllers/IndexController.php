...
class Suit_Measurement_IndexController extends Mage_Core_Controller_Front_Action {
							...
							if($_POST['customsize']=="customsize")
								{
									...
									foreach($measure_raw_data as $measure_raw_data_key=>$measure_raw_data_val){
									 ...
									 //$return = array('result'=> unserialize($_SESSION['product_sku']));
									  ...
									  $_SESSION['product_sku'][$_POST[sizeOption]][$mname]['sizeoption']=$_POST[sizeOption];
										  unset($_SESSION['product_sku']['Custom Size'][$_POST[productSku]]);
									}
	    ...
	    $hip=$_SESSION['product_sku']['Custom Size'][$_POST[productSku]]['hip'];
                     ...
                     $armHole=$_SESSION['product_sku']['Custom Size'][$_POST[productSku]]['armHole'];
                     $neckDeepFront=$_SESSION['product_sku']['Custom Size'][$_POST[productSku]]['neckDeepFront'];
                     $neckDeepBack=$_SESSION['product_sku']['Custom Size'][$_POST[productSku]]['neckDeepBack'];
                     $thigh=$_SESSION['product_sku']['Custom Size'][$_POST[productSku]]['thigh'];
                     $knee=$_SESSION['product_sku']['Custom Size'][$_POST[productSku]]['knee'];
                     $mori=$_SESSION['product_sku']['Custom Size'][$_POST[productSku]]['mori'];
		...
		$ret .='<table border=0px>
			<tr>
				<th colspan="5" style="text-align:center; background-color:#87C540;"> Your Custom Size </th>
                                                   ...
                                                   <tr class="even_1">
				<th >Neck Deep Front</th>
				<td class="val_even">'. $neckDeepFront .'</td>
				<td></td>
                                <th >Neck Deep Back</th>
				<td class="val_even">'. $neckDeepBack .'</td>
				
			</tr>
			<tr class="odd_1">
				<th >Sleeve Length</th>
				<td class="val_odd">'. $sleeveLength .'</td>
				<td></td>
                                <th >Across Shoulder</th>
				<td class="val_odd">'. $acrossshoulder .'</td>
				
			</tr>
                                                   <tr class="even_1">
				<th >Arm Hole</th>
				<td class="val_odd">'. $armHole.'</td>
				<td></td>
                                                                <th >Bust</th>
				<td class="val_odd">'. $bust .'</td>
			...
			<tr class="odd_1">
				...
				<td class="val_odd">'. $outSeamLength .'</td>
                                                   ...
                                                   <tr class="even_1">
				<th>In Seam Length</th>
				<td class="val_even">'. $inSeamLength .'</td>
				<td></td>
				<th>Thigh</th>
				<td class="val_even">'. $thigh .'</td>
			</tr>
                                                    <tr class="odd_1">
				<th>Knee</th>
				<td class="val_odd">'. $knee .'</td>
				<td></td>
				<th>Mori</th>
				<td class="val_odd">'. $mori .'</td>
			</tr>
